...
# 1. Source ROS Humble 环境，切换目录并修改脚本权限
source /opt/ros/humble/setup.bash && \
cd "$SCRIPT_DIR/../install/sensor_tools/share/sensor_tools/scripts/" && \
chmod 777 usb_camera.py

# 2. Source 本地工作空间设置，并启动 Launch 文件
source $SCRIPT_DIR/../install/setup.bash && ros2 launch sensor_tools open_sensor_gripper_realsense.launch.py \
    sensor_depth_camera_no:=_$sensor_depth_camera_no \
    ...
    gripper_fisheye_port:=$gripper_fisheye_port \
